...
public class Navigation implements Runnable {
	...
	/**
	 * Quando acionado faz o calculo da nova posição do robo levando em conta
	 * sua orientação<br>
	 * Só deve ser acionado quando for identificado que de fato o robo mudou de
	 * celula
	 */
	 ...
	 * rodas, o método segura o programa dentro dele
	 * 
	 * @param graus
	 *            inteiro positivo (anti-horário) inteiro negativo (horário)
	 */
